...
// A: To protect users as if database is leaked passwords can't be read.

// Q2: Can you reverse a bcrypt hash to get the original password?
// A: No bcrypt is one-way

// Q3: What does the number 10 in bcrypt.hash(password, 10) mean?
// A: It's the cost factor and higher numbers make hashing slower and more secure.

// Q4: Why do we use bcrypt.compare() instead of comparing strings directly?
// A: bcrypt.compare() hashes the input and checks if it matches and can't use strings because the password is hashed.

// Q5: What happens if two users have the same password?
// A: They still get different hashes because bcrypt generates a unique salt every time.
// ============================================================================